...
public class Snark
{
    ...
    public final static int MAX_PORT = 6999;
        ...
        StorageListener slistener, CoordinatorListener clistener)
    {
        ...
        log.log(Level.FINE, "KPN-MN: My peer id: " + PeerID.idencode(id));
    }
    ...
    public Snark copyContentsTo () {
    	Snark sybil = new Snark(this.torrent, this.ip, this.user_port, this.slistener, this.clistener);
    	log.log(Level.FINE, "KPN-MN: My sybil peer id: " + PeerID.idencode(sybil.id));
    	sybil.port = this.port;
    	sybil.serversocket = this.serversocket;
    	sybil.meta = this.meta;
    	sybil.storage = this.storage;
    	return sybil;
    }
        ...
        throws IOException
    {
        ...
        if (serversocket == null) {
            ...
            if (ip != null || user_port != -1) {
                ...
                log.log(Level.WARNING, "KPN-MN: " + message);
            }
            port = -1;
        } else {
            port = serversocket.getLocalPort();
            log.log(Level.FINE, "KPN-MN: Listening on port: " + port);
        }
        ...
        try {
            ...
            if (f != null && f.exists()) {
                if (ip == null) {
                    ...
                    log.log(Level.INFO,
                        "KPN-MN: Trying to create metainfo torrent for '" + torrent
                            + "'");
                    try {
        ...
        log.log(Level.INFO, "KPN-MN: " + meta.toString());
    }
        ...
        throws IOException
    {
        ...
        if (ip != null) {
            ...
            */
            ...
            httpacceptor = null;
            SnarkApplication.startTime = System.nanoTime();
            log.log(Level.INFO, "KPN-MN: Started download at : " + (new Timestamp(new java.util.Date().getTime())));
        }
        ...
        if (ip != null) {
            log.log(Level.INFO, "KPN-MN: Torrent available on " + "http://" + ip + ":"
    ...
    public static void abort (String s, IOException ioe)
        throws IOException
    {
        log.log(Level.SEVERE, "KPN-MN: " + s, ioe);
