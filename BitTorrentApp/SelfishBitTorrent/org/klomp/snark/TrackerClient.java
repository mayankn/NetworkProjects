...
public class TrackerClient extends Thread
{
        ...
        try {
            ...
            while (!started && failures < MAX_FAILURE_COUNT) {
                try {
                    ...
                    log.log(Level.WARNING, "KPN-MN: Could not contact tracker at '"
                        + announce, ioe);
                }

                if (!started) {
                    failures++;
                    log.log(Level.FINER, "KPN-MN:      Retrying in 5s...");
                    try {
                        // Sleep five seconds...
                        Thread.sleep(5 * 1000);
            ...
            log.log(Level.SEVERE, "KPN-MN: Fatal exception in TrackerClient", t);
        } finally {
            try {
                if (started) {
        ...
        throws IOException
    {
        ...
        URL u = new URL(s);
        log.log(Level.FINE, "KPN-MN: Sending TrackerClient request: " + u);
        ...
        log.log(Level.FINE, "KPN-MN: TrackerClient response: " + info);
