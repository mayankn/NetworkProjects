...
public class Storage
{
    ...
    private static void addFiles (List<File> l, File f)
    {
        if (!f.isDirectory()) {
            ...
            if (files == null) {
                log.log(Level.WARNING, "KPN-MN: Skipping '" + f
                    + "' not a normal file.");
                return;
            }
    ...
    public void check () throws IOException
    {
        ...
        if (files == null) {
            // Create base as file.
            log.log(Level.INFO, "KPN-MN: Creating/Checking file: " + base);
            ...
            // Create base as dir.
            log.log(Level.INFO, "KPN-MN: Creating/Checking directory: " + base);
    ...
    private void checkCreateFiles () throws IOException
    {
        ...
        for (int i = 0; i < rafs.length; i++) {
            ...
            if (length == lengths[i]) {
                ...
                log.log(Level.FINE, "KPN-MN: Truncating '" + names[i]
    ...
    public byte[] getPiece (int piece) throws IOException
    {
        if (!bitfield.get(piece)) {
        	// Even if we don't have the piece, send a fake piece
            return null;
        	/*int piece_length = metainfo.getPieceLength(piece);
            return getFakePiece(piece_length);*/
    ...
    /**
     * @param piece - the piece being requested
     * @param bs - the byte array of the piece being requested
     * @return a fake piece of the length of the piece being requested
     * @throws IOException
     */
    private byte[] getFakePiece (int piece_length)
            throws IOException
        {
            Random rnd = new Random();
            byte[] randomBytes = new byte[piece_length];
