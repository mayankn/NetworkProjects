    ...
    public void run ()
    {
        synchronized (coordinator.peers) {
            ...
            while (it.hasNext()) {
                ...
                log.log(Level.FINEST, "KPN-MN: " + peer + ":" + " ul: " + upload
                ...
                if (coordinator.uploaders >= PeerCoordinator.MAX_UPLOADERS
                    ...
                    if (!peer.isInterested()) {
                        log.log(Level.FINER, "KPN-MN: Choke uninterested peer: " + peer);
                        ...
                        log.log(Level.FINEST, "KPN-MN: Choke choking peer: " + peer);
                        peer.setChoking(true);
                        uploaders--;
                        coordinator.uploaders--;
                        ...
                        log.log(Level.FINEST,
                            "KPN-MN: Choke downloader that doesn't deliver:" + peer);
                        peer.setChoking(true);
                        uploaders--;
                        coordinator.uploaders--;
            ...
            if (uploaders >= PeerCoordinator.MAX_UPLOADERS
                ...
                log.log(Level.FINEST, "KPN-MN: Choke worst downloader: "
                    + worstDownloader);
            ...
            // unchoke with peers synchronized
            /*synchronized (coordinator.peers) {
            	coordinator.unchokePeer();
            }*/
